...
export default function Home() {
  ...
  const handleGlobalTransfer = async () => {
    ...
    let globalTransferTransaction = await wrapperContext?.contract.call(
      "globalTransfer",
      [
        activeToken?.id,
        tokenTo?.id,
    ...
    <>
        ...
        <div className="w-full mx-auto max-w-xs">
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                setActiveToken(
                  fromTokenInfos.find((t) => t.id == e.target.value)
                );
              }}
            >
      ...
      <input placeholder="Token To" /> */}
        ...
        <div className="w-full mx-auto max-w-xs">
          ...
          /> */}
              ...
              <input
                ...
                onInput={(e) => {
                  ...
                  const timeOutId = setTimeout(async () => {
                    const globalShareValue = await wrapperContext.contract.call(
                      "getGlobalValueShare",
                      [
                    ...
                    setGlobalShareTransfer(
                      globalShareValue / wrapperContext.denominator
                    );
                  }, 500);
            ...
            {amonutToSend != "" && !!globalShareTransfer ? (
              <div className="mt-1 text-sm" style={{ fontSize: "1em" }}>
        ...
        <div
          ...
          tabIndex="-1"
          className={
            "fixed flex items-center justify-center top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[100%] bg-[#151515] bg-opacity-60 max-h-full " +
            (isTransactionModalOpen ? "" : "hidden")
          }
        >
          <div className="relative w-full max-w-md max-h-full">
            <div className="relative bg-black rounded-lg shadow dark:bg-g-700">
              <div className="p-6 text-center">
                ...
                <a
                  className="block text-white underline mb-5"
                  href={`https://goerli.etherscan.io/tx/${linkToTransaction}`}
                  target="_blank"
                >
